...
object OpenAiServerState {
    ...
    var runningServer: com.google.ai.edge.gallery.relay.openai.OpenAiServer? = null
     ...
     * successful [com.google.ai.edge.gallery.relay.openai.OpenAiServer.start] and cleared whenever the
