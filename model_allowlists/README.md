...
by underscores, so version 1.0.20 requests `1_0_20.json`. If the fetch fails, the app
...
Google publishes, the fetch fails and the app falls back with no error shown. On 2026-09-26 this
was the case: the app was at 1.0.20, upstream too, and `1_0_20.json` returned 404.
